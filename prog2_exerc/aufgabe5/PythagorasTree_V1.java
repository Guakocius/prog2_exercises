...
public class PythagorasTree_V1 {
    ...
    public static void drawPyTree(double angle, double x, double y, double l, double newPenWidth) {
        if (l >= BORDER) {
            ...
            if (v > BORDER) {
            drawPyTree(RAD_DELTA + angle, D.getX(), D.getY(), u, newPenWidth*1.10*(u/l));
            drawPyTree(Math.toRadians(-90)+RAD_DELTA+angle, E.getX(), E.getY(), v, newPenWidth*1.10*(u/l));
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        drawPyTree(RAD_GAMMA, 6, 1, 1.7, 0.004);
    }
}
